...
export default function PurchasesPaymentsListPage() {
  ...
  const keyOf = (r: any) => `${String(r.type)}-${String(r.id)}`
      ...
      <div className="flex items-center justify-between gap-4">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            <DropdownMenuItem disabled>All Payments</DropdownMenuItem>
            <DropdownMenuItem disabled>Expense payments (coming soon)</DropdownMenuItem>
            <DropdownMenuItem disabled>Purchase bill payments (coming soon)</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  filtered.map((r) => (
                    <TableRow key={keyOf(r)} className="hover:bg-muted/40">
                      ...
                      <TableCell>
                        <Link className="text-primary underline" href={`/purchases/payments/${r.type}/${r.id}`}>
                          {r.id}
                        </Link>
                      </TableCell>
                      ...
                      <TableCell className="text-muted-foreground">
                        {r.referenceId ? (
                          <Link
                            ...
                            href={r.type === "expense" ? `/expenses/${r.referenceId}` : `/purchase-bills/${r.referenceId}`}
                          >
