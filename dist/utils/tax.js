 ...
 */
export function pickFirstUnusedNumericCode(usedCodes, start, end) {
 ...
 */
export async function ensureTaxPayableAccount(tx, companyId) {
    ...
    const used = new Set(liabilityCodes.map((a) => String(a.code ?? '').trim()).filter(Boolean));
